...
\section{Resultados}
\IfFileExists{anexos/resultados_generados.tex}{\input{anexos/resultados_generados.tex}}{Resultados no disponibles.}

\begin{figure}[H]
\centering
\includegraphics[width=.78\linewidth]{figuras/final/01_heatmap_migrations.png}
\caption{Migraciones por inserción para $N=100000$. Los valores disminuyen al crecer $\gamma$.}
...
\caption{Compromiso entre migraciones, memoria y colisiones. Ningún tratamiento minimiza simultáneamente las tres métricas.}
\label{fig:pareto}
\end{figure}
...
\item Código Python incluido.
\item Datos y generadores de instancias incluidos.
\item Semillas aleatorias registradas.
\item Versiones de dependencias indicadas.
\item Instrucciones de ejecución en \texttt{README.md}.
\item Scripts para reproducir tablas y figuras.
\end{itemize}
